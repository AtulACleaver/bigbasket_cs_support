      ...
      <div className="max-w-sm mx-auto bg-white min-h-screen shadow-xl">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="space-y-4">
            ...
            {/* Bank Details Form */}
            {refundMethod === 'bank' && (
              <div className="space-y-4 p-5 bg-gray-50 rounded-xl border animate-in slide-in-from-bottom-3 duration-300">
                <h4 className="font-medium text-gray-900 text-sm">Bank Account Details</h4>
                <div className="space-y-4">
